...
EOF
    ...
    RUN_TEST utool/util_arg.py --test-parse_cfgstr_list:0
    RUN_TEST utool/util_autogen.py --test-make_args_docstr:0
    RUN_TEST utool/util_autogen.py --test-make_default_docstr:0
    RUN_TEST utool/util_autogen.py --test-make_default_module_maintest:0
    ...
    RUN_TEST utool/util_dict.py --test-all_dict_combinations:0
    ...
    RUN_TEST utool/util_regex.py --test-named_field_repl:0
    RUN_TEST utool/util_regex.py --test-regex_replace:0
    RUN_TEST utool/util_regex.py --test-regex_replace:1
    ...
    RUN_TEST utool/util_tests.py --test-parse_docblocks_from_docstr:0

...
def compile_cython(fpath):
    ...
    if util_cplat.WIN32:
        ...
        pyinclude = r'-IC:\Python27\include;' + numpy_include
        cython_py = 'cython.py'
    else:
        cc_exe = 'gcc'
        cython_py = 'cython'
    ...
    gcc_build_cmd = cc_exe + ' ' + gcc_flags + ' -o ' + fname_so + ' ' + fname_c

    import os
    # HACK
    ret = os.system(cython_build_cmd)
    ret = os.system(gcc_build_cmd)

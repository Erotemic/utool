...
def get_nonconflicting_path(path_, dpath=None, offset=0, suffix=None,
                            force_fmt=False):
    r"""
    Creates a path garuenteed to not exist yet.
    ...
    CommandLine:
        python -m utool.util_dev get_nonconflicting_path
    ...
    Example:
        ...
        >>> path_ = base + '/tmp.txt'
        >>> newpath = ut.get_nonconflicting_path(path_)
    ...
    Example:
        ...
        >>> path_ = base + '/dir'
        >>> suffix = '_old'
        >>> newpath = ut.get_nonconflicting_path(path_, suffix=suffix)
        >>> assert basename(newpath) == 'tmp1.txt'
    """
    import utool as ut
...
non_existing_path = get_nonconflicting_path

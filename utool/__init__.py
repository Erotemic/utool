...
if DOELSE:
    ...
    from utool.util_list import (accumulate, alloc_lists, alloc_nones, 
                                 ...
                                 list_depth, list_getat, list_intersection, 
                                 list_issubset, list_issuperset, list_replace, 
                                 list_set_equal, list_take, list_where, 
                                 listclip, listfind, partial_imap_1to1, 
    ...
    from utool.util_tests import (BIGFACE, HAPPY_FACE, HAPPY_FACE_BIG, 
                                  ...
                                  def_test, doctest_funcs, doctest_module_list, 

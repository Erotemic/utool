...
if __DYNAMIC__:
    ...
    from .util_list import (alloc_lists, alloc_nones, assert_all_not_None,
                            ...
                            get_func_name, get_list_column, imap, inbounds,
                            index_of, intersect2d, intersect2d_numpy,
                            intersect_ordered, invertable_flatten, list_getat,
                            list_index, list_replace, listfind, npfind,
                            partial_imap_1to1, random_indexes, safe_listget,
                            safe_slice, scalar_input_map, sortedby, spaced_indexes,

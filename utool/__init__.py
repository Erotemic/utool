...
if DOELSE:
    ...
    from utool.util_distances import (L1, L2, L2_sift, L2_sqrd, 
                                      compute_distances, cos_sift, emd, 
    ...
    from utool.util_grabdata import (BadZipfile, TESTIMG_URL_DICT, 
                                     ...
                                     fix_dropbox_link, get_valid_test_imgkeys, 
    ...
    from utool.util_inspect import (get_dev_hints, get_docstr, 
    ...
    from utool.util_list import (accumulate, alloc_lists, alloc_nones, 
                                 ...
                                 list_take, list_type_profile, list_where, 
                                 listclip, listfind, lmap, make_sortby_func, 

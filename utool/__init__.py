...
if DOELSE:
    ...
    from utool.util_alg import (FOOT_PER_MILE, HAVE_NUMPY, HAVE_SCIPY, 
                                KM_PER_MILE, PHI, PHI_A, PHI_B, TAU, absdiff, 
                                almost_allsame, almost_eq, apply_grouping, 
                                bayes_rule, choose, colwise_diag_idxs, 
                                compare_groupings, cumsum, defaultdict, 
                                deg_to_rad, diagonalized_iter, edit_distance, 
                                enumerate_primes, euclidean_dist, 
                                expensive_task_gen, fibonacci, 
                                ...
                                triangular_number, ungroup, ungroup_unique, 
    ...
    from utool.util_dev import (ClassAttrDictProxy, ColumnLists, DEPRICATED, 
                                ...
                                LIVE_INTERACTIVE_ITER, MemoryTracker, NiceRepr, 
                                ...
                                find_interesting_stats, focusvim, 
    ...
    from utool.util_gridsearch import (CountstrParser, DimensionBasis, 
                                       ...
                                       NAMEVARSEP, ParamInfo, ParamInfoBool, 
    ...
    from utool.util_inspect import (KWReg, LIB_PATH, VERBOSE_INSPECT, 
                                    VERYVERB_INSPECT, argparse_funckw, 
                                    check_module_usage, 
    ...
    from utool.util_path import (ChdirContext, IMG_EXTENSIONS, PRINT_CALLER, 
                                 ...
                                 fnames_to_fpaths, fpath_has_ext, 
                                 fpath_has_imgext, fpaths_to_fnames, 
                                 ...
                                 make_grep_resultstr, matching_fnames, move, 
    ...
    from utool.util_str import (BACKSLASH, DOUBLE_QUOTE, ENABLE_COLORS, 
                                ...
                                scalar_str, seconds_str, singular_string, 

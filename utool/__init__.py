...
if DOELSE:
    ...
    from utool.util_alg import (HAVE_NUMPY, HAVE_SCIPY, PHI, PHI_A, PHI_B, 
                                ...
                                deg_to_rad, enumerate_primes, euclidean_dist, 
    ...
    from utool.util_dict import (AutoVivification, all_dict_combinations, 
                                 ...
                                 assert_keys_are_subset, build_conflict_dict, 
                                 count_dict_vals, delete_dict_keys, 
                                 dict_assign, dict_find_keys, 
    ...
    from utool.util_latex import (compile_latex_text, compress_pdf, 
                                  ...
                                  get_latex_figure_str, is_substr, 
    ...
    from utool.util_list import (accumulate, alloc_lists, alloc_nones, 
                                 ...
                                 list_issuperset, list_replace, list_roll, 
                                 list_set_equal, list_take, list_transpose, 
                                 list_type_profile, list_where, listclip, 
                                 listfind, lmap, make_index_lookup, 
                                 make_sortby_func, multi_replace, not_list, 

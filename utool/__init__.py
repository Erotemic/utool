...
if DOELSE:
    ...
    from utool.util_alg import (HAVE_NUMPY, HAVE_SCIPY, PHI, PHI_A, PHI_B,
                                absdiff, almost_eq, bayes_rule,
                                build_reverse_mapping, cartesian, choose,
                                cumsum, defaultdict, deg_to_rad,
    ...
    from utool.util_arg import (ArgumentParser2, DEBUG2, NOT_QUIET, NO_ASSERTS,
                                ...
                                switch_sanataize,)
    from utool.util_assert import (assert_all_in, assert_all_not_None,
                                   assert_almost_eq, assert_eq,
                                   assert_inbounds, assert_lessthan,
    ...
    from utool.util_dict import (AutoVivification, all_dict_combinations,
                                 ...
                                 dict_intersection, dict_keysubset,
    ...
    from utool.util_list import (accumulate, alloc_lists, alloc_nones,
                                 ...
                                 list_where, list_ziptake, listclip, listfind,
                                 lmap, make_index_lookup, make_sortby_func,
    ...
    from utool.util_str import (DOUBLE_QUOTE, GLOBAL_TYPE_ALIASES, NEWLINE,
                                ...
                                replace_nonquoted_text, scalar_str,

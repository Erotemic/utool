...
if DOELSE:
    ...
    from utool.util_dbg import (COLORED_EXCEPTIONS, EmbedOnException, FORCE_TB, 
                                ...
                                varname_regex,) 
    from utool.util_dev import (ClassAttrDictProxy, DEPRICATED, DEVELOPER_MODE, 
                                DictLike_old, ENABLE_MEMTRACK, INDEXABLE_TYPES, 
                                InstanceList, InteractiveIter, 
    ...
    from utool.util_gridsearch import (CountstrParser, DimensionBasis, 
                                       ...
                                       parse_cfgstr_list2, 
                                       parse_cfgstr_name_options, parse_paren3, 
    ...
    from utool.util_graph import (accum_path_data, all_multi_paths, 
                                  all_nodes_between, all_simple_source_paths, 
                                  ...
                                  merge_level_order, nx_delete_edge_attr, 
                                  nx_delete_node_attr, nx_transitive_reduction, 
                                  path_to_leafs, paths_to_root, reverse_path, 
                                  reverse_path_edges, shortest_levels, 
                                  subgraph_from_edges, testdata_graph, 
                                  topsort_ordering, traverse_path,) 
    ...
    from utool.util_logging import (LOGGING_VERBOSE, PRINT_ALL_CALLERS, 
                                    ...
                                    get_utool_logger, logdir_cacheid, 
    ...
    from utool.util_list import (accumulate, alloc_lists, alloc_nones, allsame, 
                                 ...
                                 unflat_vecmap, unflatten, unflatten2, unique, 

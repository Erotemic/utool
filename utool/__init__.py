...
if DOELSE:
    ...
    from .util_cplat import (COMPUTER_NAME, DARWIN, LIB_DICT, LIB_EXT_LIST, 
                             ...
                             get_flops, get_free_diskbytes, get_install_dirs, 
                             get_lib_ext, get_pylib_ext, get_python_dynlib, 
    ...
    from .util_dev import (DEPRICATED, INDEXABLE_TYPES, InteractiveIter, 
                           MemoryTracker, auto_docstr, autofix_codeblock, 
                           compile_cython, disable_garbage_collection, 
                           doctest_funcs, enable_garbage_collection, find_exe, 
                           garbage_collect, get_cython_exe, 
                           get_doctest_examples, get_object_base, 
    ...
    from .util_list import (accumulate, alloc_lists, alloc_nones, 
    ...
    from .util_path import (IMG_EXTENSIONS, append_suffixlist_to_namelist, 
                            ...
                            file_megabytes, find_lib_fpath, fixwin32_shortname, 
                            fnames_to_fpaths, fpaths_to_fnames, 
                            get_absolute_import, get_basename_noext_list, 
                            get_basepath_list, get_ext_list, get_module_dir, 
                            glob, grep, iglob, is_module_dir, 
                            is_private_module, isfile, islink, ismount, 
                            list_images, longest_existing_path, ls, ls_dirs, 
                            ls_moduledirs, ls_modulefiles, matches_image, move, 
                            move_list, newcd, num_images_in_dir, 
                            path_ndir_split, platform_path, progress_func, 
                            remove_dirs, remove_file, remove_file_list, 
                            remove_files_in_dir, search_in_dirs, symlink, tail, 
    ...
    from .util_regex import (REGEX_VARNAME, RE_FLAGS, RE_KWARGS, 
                             get_match_text, modify_quoted_strs, named_field, 
                             named_field_regex, regex_get_match, regex_matches, 
    ...
    from .util_time import (Timer, exiftime_to_unixtime, get_day, get_month, 
                            ...
                            get_timestats_str, get_year, tic, timestamp, toc, 

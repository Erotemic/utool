...
if DOELSE:
    ...
    from utool.util_cache import (BadZipFile, Cachable, Cacher, 
                                  GlobalShelfContext, LRUDict, USE_CACHE, 
    ...
    from utool.util_dict import (AutoVivification, all_dict_combinations, 
                                 ...
                                 order_dict_by, partial, update_existing, 
                                 updateif_haskey,) 
    ...
    from utool.util_list import (accumulate, alloc_lists, alloc_nones, 
                                 ...
                                 list_unflat_take, list_where, list_ziptake, 
                                 listclip, listfind, lmap, make_index_lookup, 
    ...
    from utool.util_str import (DOUBLE_QUOTE, NEWLINE, SINGLE_QUOTE, TAU, 
                                ...
                                truncate_str, tupstr, unindent, verts_str,) 
    ...
    from utool.util_regex import (REGEX_ESCSTR, REGEX_FLOAT, REGEX_INT, 
                                  REGEX_RVAL, REGEX_STR, REGEX_VARNAME, 
                                  REGEX_WHITESPACE, RE_FLAGS, RE_KWARGS, 
                                  ...
                                  sedfile, whole_word,) 
    from utool.util_time import (Timer, ensure_timedelta, exiftime_to_unixtime, 

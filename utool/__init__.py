...
if DOELSE:
    ...
    from utool.util_path import (IMG_EXTENSIONS, append_suffixlist_to_namelist, 
                                 ...
                                 copy_task, delete, dirsplit, ensuredir, 
                                 ensurepath, existing_subpath, ext, 
    ...
    from utool.util_str import (GLOBAL_TYPE_ALIASES, TAU, align, align_lines, 
                                bbox_str, byte_str, byte_str2, clipstr, 
                                codeblock, dict_aliased_repr, 

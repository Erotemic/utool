...
if DOELSE:
    ...
    from utool.util_grabdata import (BadZipfile, TESTIMG_URL_DICT, 
                                     ...
                                     grab_file_url, grab_selenium_chromedriver, 
                                     grab_test_imgpath, grab_zipped_url, 
                                     open_url_in_browser, scp_pull, 
    ...
    from utool.util_str import (DOUBLE_QUOTE, GLOBAL_TYPE_ALIASES, NEWLINE, 
                                ...
                                clipstr, codeblock, cond_phrase, 
                                dict_aliased_repr, dict_itemstr_list, dict_str, 
                                doctest_code_line, doctest_repr, 
                                extend_global_aliases, file_megabytes_str, 
                                filesize_str, flatten_textlines, func_str, 
                                ...
                                indent_rest, indentcat, indentjoin, joins, 

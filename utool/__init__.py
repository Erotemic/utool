...
if DOELSE:
    ...
    from utool.util_alg import (HAVE_NUMPY, HAVE_SCIPY, PHI, PHI_A, PHI_B, 
                                ...
                                enumerate_primes, euclidean_dist, fibonacci, 
                                ...
                                normalize, number_of_decimals, rad_to_deg, 
                                safe_div, safe_pdist, self_prodx, 
    ...
    from utool.util_cache import (BadZipFile, Cachable, CacheMissException, 
                                  Cacher, DictLike2, GlobalShelfContext, 
                                  KeyedDefaultDict, LRUDict, LazyDict, 
                                  LazyList, ShelfCacher, USE_CACHE, 
                                  ...
                                  load_cache, partial, save_cache, shelf_open, 
    ...
    from utool.util_dev import (AlignedListDictProxy, ClassAttrDictProxy, 
                                DEPRICATED, DEVELOPER_MODE, DictLike, 
                                ENABLE_MEMTRACK, INDEXABLE_TYPES, 
                                InteractiveIter, MemoryTracker, STAT_KEY_ORDER, 
                                USER_MODE, are_you_sure, argparse_funckw, 
                                ...
                                ensure_str_list, extract_timeit_setup, 
                                ...
                                get_stats_str, get_submodules_from_dpath, info, 
    ...
    from utool.util_grabdata import (BadZipfile, TESTIMG_URL_DICT, 
                                     ...
                                     read_s3_contents, s3_dict_encode_to_str, 
    ...
    from utool.util_io import (HAS_NUMPY, HAVE_LOCKFILE, load_cPkl, load_data, 
                               ...
                               read_from, read_lines_from, readfrom, save_cPkl, 
                               save_data, save_hdf5, save_numpy, save_pytables, 
                               save_text, try_decode, write_to, writeto,) 
    from utool.util_iter import (and_iters, cycle, ensure_iterable, 
                                 ...
                                 itertwo, next_counter, roundrobin, 
                                 wrap_iterable,) 
    from utool.util_inspect import (KWReg, LIB_PATH, dummy_func, exec_func_src, 
                                    filter_valid_kwargs, 
                                    ...
                                    get_module_owned_functions, help_members, 
    ...
    from utool.util_list import (accumulate, alloc_lists, alloc_nones, 
                                 ...
                                 index_to_boolmask, intersect_ordered, 
                                 ...
                                 take_percentile, tuplize, type_profile, 
                                 unflat_map, unflat_unique_rowid_map, 
                                 unflat_vecmap, unflatten, unflatten2, 
                                 unique_keep_order, unique_ordered, 
    ...
    from utool.util_print import (ENABLE_COLORS, Indenter, NO_INDENT, 
                                  PrintStartEndContext, color_text, colorprint, 
                                  dictprint, get_colored_diff, highlight_code, 
                                  highlight_text, horiz_print, printNOTQUIET, 
    ...
    from utool.util_str import (DOUBLE_QUOTE, NEWLINE, NO_TRUNCATE, 
                                SINGLE_QUOTE, TAU, TAUFMTSTR, TAUSTR, 
                                TRIPLE_DOUBLE_QUOTE, TRIPLE_SINGLE_QUOTE, 
                                USE_GLOBAL_INFO, align, align_lines, 
                                array2string2, array_repr2, autoformat_pep8, 
                                bbox_str, bubbletext, byte_str, byte_str2, 
                                chr_range, clipstr, closet_words, codeblock, 
                                conj_phrase, dict_itemstr_list, dict_str, 
                                difftext, doctest_code_line, doctest_repr, 
                                edit_distance, ensure_ascii, ensure_unicode, 
                                ensure_unicode_strlist, file_megabytes_str, 
                                filesize_str, filtered_infostr, 
                                flatten_textlines, format_text_as_docstr, 
                                func_callsig, func_defsig, func_str, 
                                ...
                                indentjoin, is_byte_encoded_unicode, is_url, 
                                joins, list_str, list_str_summarized, 
                                listinfo_str, long_fname_format, lorium_ipsum, 
                                msgblock, newlined_list, number_text_lines, 
                                numeric_str, numpy_str, numpy_str2, obj_str, 
                                ...
                                to_camel_case, to_title_caps, truncate_str, 

...
if DOELSE:
    ...
    from utool.util_cache import (BadZipFile, Cachable, Cacher,
                                  ...
                                  consensed_cfgstr, default_appname,
                                  delete_global_cache, get_argnames,
                                  get_cfgstr_from_args, get_default_appname,
                                  get_funcname, get_global_cache_dir,
                                  get_global_shelf_fpath, get_kwdefaults,
                                  get_lru_cache, global_cache_dname,
    ...
    from utool.util_func import (general_get, general_set, identity,
                                 uinput_1to1,)
    from utool.util_grabdata import (BadZipfile, archive_files, download_url,
    ...
    from utool.util_inspect import (get_docstr, get_func_argspec,
    ...
    from utool.util_list import (accumulate, alloc_lists, alloc_nones,
                                 ...
                                 invertable_flatten2, is_subset_of_any,
                                 issorted, isunique, list_all_eq_to,
                                 list_argsort, list_cover, list_deep_types,
                                 list_depth, list_intersection, list_issubset,
    ...
    from utool.util_path import (IMG_EXTENSIONS, PRINT_CALLER,
                                 ...
                                 get_module_subdir_list, get_relative_modpath,
                                 get_standard_exclude_dnames,
                                 get_standard_include_patterns, glob,
    ...
    from utool.util_parallel import (BACKEND, close_pool, ensure_pool,
                                     ...
                                     new_pool, process, set_num_procs,
    ...
    from utool.util_str import (GLOBAL_TYPE_ALIASES, TAU, TAUFMTSTR, TAUSTR,
                                ...
                                get_textdiff, get_unix_timedelta,
                                get_unix_timedelta_str, horiz_string, hz_str,
                                indent_list, indentjoin, joins,
                                list_aliased_repr, list_str, listinfo_str,
                                long_fname_format, msgblock, newlined_list,
                                number_text_lines, order_of_magnitude_str,
                                packstr, padded_str_range, remove_chars,
                                remove_vowels, replace_nonquoted_text,
                                seconds_str, singular_string, str2,
                                str_between, textblock, theta_str, tupstr,
                                unindent, var_aliased_repr, verts_str,)
    from utool.util_sysreq import (DEBUG, ensure_in_pythonpath, in_virtual_env,
    ...
    from utool.util_tests import (BIGFACE, HAPPY_FACE, HAPPY_FACE_BIG,
                                  HAPPY_FACE_SMALL, PRINT_FACE, PRINT_SRC,
                                  ...
                                  get_doctest_testtup_list, get_func_source,

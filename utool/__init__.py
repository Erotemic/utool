...
if DOELSE:
    ...
    from utool.util_alg import (FOOT_PER_MILE, HAVE_NUMPY, HAVE_SCIPY, 
                                ...
                                colwise_diag_idxs, cumsum, defaultdict, 
                                deg_to_rad, diagonalized_iter, edit_distance, 
                                enumerate_primes, euclidean_dist, 
                                expensive_task_gen, factors, fibonacci, 
                                fibonacci_approx, fibonacci_iterative, 
                                fibonacci_recursive, find_group_consistencies, 
    ...
    from utool.util_cplat import (COMPUTER_NAME, DARWIN, EXIT_FAILURE, 
                                  EXIT_SUCCESS, LIB_DICT, LIB_EXT_LIST, LINUX, 
                                  OS_TYPE, PYLIB_DICT, UNIX, WIN32, 
                                  assert_installed_debian, change_term_title, 
                                  check_installed_debian, chmod, 
                                  chmod_add_executable, cmd, cmd2, editfile, 
    ...
    from utool.util_dict import (AutoVivification, DefaultValueDict, DictLike, 
                                 ...
                                 order_dict_by, sort_dict, update_dict, 
                                 update_existing,) 
    ...
    from utool.util_graph import (all_multi_paths, approx_min_num_components, 
                                  ...
                                  nx_gen_edge_attrs, nx_gen_node_attrs, 
    ...
    from utool.util_hash import (ALPHABET, ALPHABET_16, ALPHABET_27, BIGBASE, 
                                 ...
                                 combine_uuids, convert_hexstr_to_bigbase, 
                                 deterministic_uuid, get_file_hash, 
                                 get_file_uuid, get_zero_uuid, 
                                 ...
                                 write_hash_file, write_hash_file_for_path,) 
    ...
    from utool.util_iter import (and_iters, cycle, ensure_iterable, 
                                 ...
                                 random_combinations, wrap_iterable,) 
    ...
    from utool.util_list import (accumulate, alloc_lists, alloc_nones, allsame, 
                                 ...
                                 rebase_labels, recursive_replace, 

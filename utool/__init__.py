...
if DOELSE:
    ...
    from utool.util_dev import (ClassAttrDictProxy, ColumnLists,
                                ...
                                STAT_KEY_ORDER, Shortlist, USER_MODE,
                                are_you_sure, autopep8_diff, compile_cython,
                                copy_text_to_clipboard, delayed_retry_gen,
    ...
    from utool.util_dict import (AutoVivification, DefaultValueDict, DictLike,
                                 ...
                                 order_dict_by, sort_dict, update_existing,
                                 updateif_haskey,)
    ...
    from utool.util_graph import (all_multi_paths, approx_min_num_components,
                                  bfs_conditional, bfs_multi_edges, bzip,
    ...
    from utool.util_list import (accumulate, alloc_lists, alloc_nones, allsame,
                                 and_lists, argmax, argsort, aslist, compress,
                                 ...
                                 listfind, lmap, lzip, make_index_lookup,
    ...
    from utool.util_profile import (Profiler, clean_line_profile_text,
                                    clean_lprof_file, dump_profile_text,
                                    fix_rawprofile_blocks, get_block_id,
                                    get_block_totaltime, get_profile_text,
                                    get_summary, make_profiler,

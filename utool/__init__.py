...
if DOELSE:
    ...
    from utool.util_alg import (HAVE_NUMPY, HAVE_SCIPY, PHI, PHI_A, PHI_B,
                                ...
                                get_phi_ratio1, greedy_max_inden_setcover,
                                group_items, haversine, inbounds, is_prime,
    ...
    from utool.util_autogen import (PythonStatement, auto_docstr,
                                    ...
                                    is_modname_in_pythonpath, make_args_docstr,
    ...
    from utool.util_cplat import (COMPUTER_NAME, DARWIN, LIB_DICT,
                                  ...
                                  cmd, editfile, ensure_app_resource_dir,
    ...
    from utool.util_dbg import (EmbedOnException, FORCE_TB, IPYTHON_EMBED_STR,
                                RAISE_ALL, TB, all_rrr, debug_exception,
    ...
    from utool.util_grabdata import (BadZipfile, TESTIMG_URL_DICT,
                                     ...
                                     download_url, fix_dropbox_link,
                                     geo_locate, get_valid_test_imgkeys,
                                     grab_file_url, grab_test_imgpath,
    ...
    from utool.util_latex import (compile_latex_text, compress_pdf,
                                  ...
                                  latex_scalar, long_substr,
                                  make_full_document, make_score_tabular,
                                  make_stats_tabular, padvec, render,
    ...
    from utool.util_io import (HAVE_LOCKFILE, load_cPkl, load_data, load_hdf5,
    ...
    from utool.util_iter import (and_iters, cycle, ensure_iterable,
                                 ...
                                 isiterable, islice, iter_multichunks, itertwo,
                                 next_counter, roundrobin,)
    from utool.util_inspect import (exec_func_sourcecode, exec_func_src,
                                    filter_valid_kwargs,
                                    ...
                                    get_kwdefaults, get_module_owned_functions,
    ...
    from utool.util_list import (accumulate, alloc_lists, alloc_nones,
                                 ...
                                 get_list_column, group_consecutives,
                                 group_consecutives_numpy, intersect_ordered,
                                 ...
                                 list_compress, list_cover, list_deep_types,
                                 list_depth, list_intersection,
                                 list_inverse_take, list_issubset,
    ...
    from utool.util_print import (Indenter, NO_INDENT, NpPrintOpts,
                                  PrintStartEndContext, colorprint,
                                  full_numpy_repr, horiz_print, printNOTQUIET,
                                  printVERBOSE, printWARN, print_dict,
                                  print_difftext, print_filesize, print_list,
                                  print_locals, print_python_code, printif,
                                  printshape,)
    from utool.util_progress import (AGGROFLUSH, NO_PROGRESS,
                                     ...
                                     progress_chunks, progress_func,
                                     progress_str, simple_progres_func,
                                     test_progress,)
    from utool.util_parallel import (BACKEND, MIN_PARALLEL_TASKS, PAR_VERBOSE,
    ...
    from utool.util_str import (DOUBLE_QUOTE, GLOBAL_TYPE_ALIASES, NEWLINE,
                                ...
                                bbox_str, byte_str, byte_str2, clipstr,
                                codeblock, cond_phrase, dict_aliased_repr,
                                dict_itemstr_list, dict_str, doctest_code_line,
                                doctest_repr, extend_global_aliases,
                                file_megabytes_str, filesize_str,
                                flatten_textlines, func_str, get_freespace_str,
                                get_indentation, get_itemstr_list,
                                get_minimum_indentation, get_textdiff,
                                get_unix_timedelta_str, horiz_string, hz_str,
                                indent, indent_list, indent_rest, indentcat,
                                indentjoin, joins, list_aliased_repr, list_str,
                                list_str_summarized, listinfo_str,
                                ...
                                padded_str_range, percent_str, remove_chars,
                                remove_doublspaces, remove_vowels,
                                replace_nonquoted_text, seconds_str,
                                singular_string, str2, str_between, textblock,
                                theta_str, truncate_str, tupstr, unindent,
    ...
    from utool.util_time import (Timer, exiftime_to_unixtime, get_datestamp,
                                 get_day, get_month, get_posix_timedelta_str,
    ...
    from utool.util_type import (BooleanType, FloatType, IntType,
                                 ...
                                 assert_int, bool_from_str,
                                 get_homogenous_list_type, get_type, is_bool,
                                 is_dict, is_float, is_func_or_method,
    ...
    from utool.util_tests import (BIGFACE, DEBUG_SRC, EXEC_MODE,
                                  ...
                                  SAD_FACE_SMALL, SYSEXIT_ON_FAIL,
                                  VERBOSE_TEST, VERBOSE_TIMER, bubbletext,

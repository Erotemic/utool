...
if DOELSE:
    ...
    from utool.util_alg import (HAVE_NUMPY, HAVE_SCIPY, PHI, PHI_A, PHI_B,
                                ...
                                choose, compare_groupings, cumsum, deg_to_rad,
    ...
    from utool.util_list import (accumulate, alloc_lists, alloc_nones,
                                 ...
                                 unflatten2, unique_keep_order, unique_ordered,
                                 unique_unordered, xor_lists,)
    ...
    from utool.util_str import (DOUBLE_QUOTE, NEWLINE, SINGLE_QUOTE, TAU,
                                ...
                                doctest_repr, edit_distance, ensure_unicode,
                                ensure_unicode_strlist, file_megabytes_str,
                                filesize_str, flatten_textlines,
                                format_text_as_docstr, func_str,
                                ...
                                replace_nonquoted_text, repr2, reprfunc,

...
if DOELSE:
    ...
    from utool.util_cplat import (COMPUTER_NAME, DARWIN, EXIT_FAILURE, 
                                  ...
                                  editfile, ensure_app_resource_dir, 
                                  ...
                                  vd, view_directory, view_file_in_directory,) 
    ...
    from utool.util_dev import (ClassAttrDictProxy, ColumnLists, 
                                ...
                                ensureqt, exec_funckw, execstr_funckw, 
                                extract_timeit_setup, find_exe, 
                                fix_super_reload_error, focusvim, 
                                ...
                                get_setdiff_info, get_statdict, get_stats, 
                                get_stats_str, get_submodules_from_dpath, 
                                grace_period, info, init_catch_ctrl_c, 
                                input_timeout, instancelist, 
                                ...
                                overrideable_partial, print_object_size, 
    ...
    from utool.util_latex import (compile_latex_text, 
                                  compile_latex_text_as_jpeg, compress_pdf, 
                                  convert_pdf_to_jpg, ensure_colvec, 
    ...
    from utool.util_graph import (all_multi_paths, approx_min_num_components, 
                                  ...
                                  merge_level_order, mincost_diameter_augment, 
    ...
    from utool.util_hash import (ALPHABET, ALPHABET_16, ALPHABET_27, BIGBASE, 
                                 DictProxyType, HASH_LEN, HASH_LEN2, SEP_BYTE, 
                                 SEP_STR, augment_uuid, b, combine_hashes, 
                                 combine_uuids, convert_bytes_to_bigbase, 
                                 convert_hexstr_to_bigbase, freeze_hash_bytes, 
                                 get_file_hash, get_file_uuid, get_zero_uuid, 
                                 hash_data, hashable_to_uuid, hashid_arr, 
                                 hashstr, hashstr27, hashstr_arr, 
                                 hashstr_arr27, hashstr_md5, hashstr_sha1, 
                                 image_uuid, make_hash, random_nonce, 
                                 random_uuid, stringlike, write_hash_file, 
    ...
    from utool.util_inspect import (BaronWraper, KWReg, LIB_PATH, 
                                    ...
                                    parse_function_names, parse_kwarg_keys, 
    ...
    from utool.util_list import (accumulate, alloc_lists, alloc_nones, allsame, 
                                 and_lists, argmax, argmin, argsort, aslist, 
                                 ...
                                 floor, get_dirty_items, get_list_column, 
                                 ...
                                 invertible_flatten1, invertible_flatten2, 
                                 ...
                                 union_ordered, unique, unique_indices, 
                                 unique_inverse, unique_ordered, 
    ...
    from utool.util_project import (GrepResult, SetupRepo, UserProfile, 
                                    ...
                                    setup_repo,) 
    from utool.util_parallel import (BACKEND, FUTURE_ON, KillableProcess, 
                                     KillableThread, MIN_PARALLEL_TASKS, 
                                     USE_GLOBAL_POOL, VERBOSE_PARALLEL, 
                                     VERYVERBOSE_PARALLEL, bgfunc, 
                                     buffered_generator, close_pool, 
                                     ensure_pool, futures_generate, 
                                     futures_map, generate, 
    ...
    from utool.util_str import (BACKSLASH, DOUBLE_QUOTE, ENABLE_COLORS, 
                                ...
                                color_diff_text, color_text, conj_phrase, 
                                countdown_flag, dict_itemstr_list, dict_str, 
                                difftext, doctest_code_line, doctest_repr, 
                                ensure_ascii, ensure_unicode, 
                                ...
                                get_callable_name, get_freespace_str, 
                                get_indentation, get_itemstr_list, 
                                get_minimum_indentation, get_textdiff, 
                                highlight_code, highlight_multi_regex, 
                                highlight_regex, highlight_text, horiz_string, 
                                hz_str, indent, indent_list, indent_rest, 
                                indentcat, indentjoin, insert_before_sentinal, 
                                ...
                                pluralize, quantstr, regex_reconstruct_split, 
                                remove_chars, remove_doublenewlines, 
                                remove_doublspaces, remove_vowels, 
                                replace_between_tags, replace_nonquoted_text, 
                                repr2, repr2_json, repr3, repr4, repr5, 
                                reprfunc, scalar_str, second_str, seconds_str, 
                                singular_string, split_sentences2, str2, 

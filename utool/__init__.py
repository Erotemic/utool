...
if DOELSE:
    ...
    from utool.util_alg import (HAVE_NUMPY, HAVE_SCIPY, PHI, PHI_A, PHI_B, 
                                ...
                                haversine, inbounds, is_prime, item_hist, 
                                knapsack, negative_minclamp_inplace, 
    ...
    from utool.util_print import (Indenter, NO_INDENT, NpPrintOpts, 
                                  ...
                                  full_numpy_repr, get_colored_diff, 
                                  horiz_print, printNOTQUIET, printVERBOSE, 
                                  printWARN, print_dict, print_difftext, 
                                  print_filesize, print_list, print_locals, 
                                  print_python_code, printif, printshape,) 

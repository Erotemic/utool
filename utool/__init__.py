...
if __DYNAMIC__:
    ...
    from .util_dbg import (IPYTHON_EMBED_STR, all_rrr, debug_exception,
                           ...
                           get_parent_frame, get_parent_globals, get_parent_locals,
                           get_reprs, get_stack_frame, get_type, haveIPython,
                           horiz_string, import_testdata, inIPython, indent,
                           ipython_execstr, ipython_execstr2, is_listlike,
                           is_valid_varname, keys_dbgstr, len_dbgstr, list_dbgstr,
                           list_allsame, load_testdata, module_functions,
    ...
    from .util_str import (GLOBAL_TYPE_ALIASES, bbox_str, byte_str, byte_str2,
                           ...
                           full_numpy_repr, func_str, get_freespace_str,
    ...
    from .util_setup import (NOOP, SETUP_PATTERNS, assert_in_setup_repo,
                             ...
                             presetup, presetup_commands, read_license, setup_chmod,
                             setuptools_setup,)

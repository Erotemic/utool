...
if DOELSE:
    ...
    from utool.util_alg import (HAVE_NUMPY, HAVE_SCIPY, PHI, PHI_A, PHI_B,
                                absdiff, almost_allsame, almost_eq, bayes_rule,
                                cartesian, choose, compare_groupings, cumsum,
                                deg_to_rad, diagonalized_iter,
                                ...
                                safe_min, safe_pdist, search_utool, self_prodx,
                                triangular_number, unixtime_hourdiff,
                                upper_diag_self_prodx, upper_diagonalized_idxs,
                                xywh_to_tlbr,)
    ...
    from utool.util_dbg import (COLORED_EXCEPTIONS, EmbedOnException, FORCE_TB,
                                ...
                                varname_regex,)
    from utool.util_dev import (DEPRICATED, DEVELOPER_MODE, ENABLE_MEMTRACK,
                                INDEXABLE_TYPES, InteractiveIter,
                                MemoryTracker, STAT_KEY_ORDER, USER_MODE,
                                are_you_sure, argparse_funckw, autopep8_diff,
    ...
    from utool.util_inject import (ARGV_DEBUG_FLAGS, DEBUG_PRINT,
                                   ...
                                   EXIT_ON_INJECT_MODNAME, HAVE_PYGMENTS,
    ...
    from utool.util_list import (accumulate, alloc_lists, alloc_nones,
                                 and_lists, compress, debug_consec_list,
                                 ...
                                 is_subset_of_any, is_superset, issorted,
                                 issubset, issuperset, isunique,
                                 ...
                                 sortedby, sortedby2, strided_sample, take,
                                 tuplize, unflat_map, unflat_unique_rowid_map,
                                 unflat_vecmap, unflatten, unflatten2,
                                 unique_keep_order, unique_ordered,
                                 unique_unordered, xor_lists, zipcompress,
                                 ziptake,)
    ...
    from utool.util_progress import (AGGROFLUSH, FORCE_ALL_PROGRESS,
                                     ...
                                     PROGRESS_FLUSH, PROGRESS_WRITE, ProgIter,
                                     ProgPartial, ProgressIter,
                                     VALID_PROGRESS_TYPES, get_nTotalChunks,
                                     log_progress, progiter, progress_chunks,
    ...
    from utool.util_project import (UserProfile, ensure_user_profile,
                                    ...
                                    sed_projects,)
    from utool.util_parallel import (BACKEND, KillableThread,

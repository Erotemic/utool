...
Notes:
    ...
    rm -rf ~/code/ibeis/tpl/utool/docs/source/auto
    cd ~/code/ibeis/tpl/utool/docs
    sphinx-apidoc --private --separate --force --output-dir ~/code/ibeis/tpl/utool/docs/source/auto ~/code/ibeis/tpl/utool/utool
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/utool/advanced/
        ...
        Enter the following information:
            Set the Repository NAME: utool
            Set the Repository URL: https://github.com/Erotemic/utool

        Make sure you have a .readthedocs.yml file

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/utool/integrations/create/
        ...
        Then go to
            ...
            https://github.com/Erotemic/utool/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/utool/versions/
"""
#
...
mod_dpath = join(repo_dpath, 'utool')
...
# html_logo = '.static/utool.svg'
# html_favicon = '.static/utool.ico'
...
latex_documents = [
    (master_doc, 'utool.tex', 'utool Documentation', 'Jon Crall', 'manual'),
]
...
man_pages = [(master_doc, 'utool', 'utool Documentation', [author], 1)]
